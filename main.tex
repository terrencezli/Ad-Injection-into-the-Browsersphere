...
In 2015, Lenovo, a top-selling laptop brand, was caught pre-installing the software \textit{Superfish}. Superfish, according to Wikipedia, ``is an advertising company that developed various advertising-supported software products based on a visual search engine'' \cite{superfish_wiki}. The controversy regarding the pre-installation of Superfish is that the software is described as malware or adware. Additionally, the US Department of Homeland Security recommended uninstalling this software and its root certificate because the software creates vulnerability to cyberattacks and interception of sensitive data \cite{superfish_wiki}.  
...
In a study done by Google, 38\% of the 50,870 Chrome extensions flagged as unwanted ad injectors were malware. This is a serious security concern as these extensions affect millions of active users \cite{ad_inject}. Besides the potential for malware, ad injectors pose additional threat to users by exposing their private data, such as browser history and page interaction, to other third-party applications.
...
In 2015, Lenovo was discovered preloading the software Superfish. Superfish 
